                      ...
                      children: <Widget>[
                        ClayContainer(
                          ...
                          child: Align(
                              ...
                              child: Column(
                                children: <Widget>[
                                  Center(child: Text('Assiduité',textScaleFactor: 1.5,textAlign: TextAlign.center,style: TextStyle(color: Colors.grey[400]))),
                                  Container(
                                    child: Align(
                                      alignment: Alignment.center,
                                      child: Padding(
                                              ...
                                              Padding(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Row(
                                                      mainAxisAlignment: MainAxisAlignment.center,
                                                      children: <Widget>[
                                                        Opacity(opacity:1.0,child: new Text(stats['accuracy'].toInt().toString()+' %',textScaleFactor: 1.6,style: TextStyle(fontFamily: 'dot',color:rangeColor(extremMoods(sevenDaysData)[1].toInt()).color[rangeColor(extremMoods(sevenDaysData)[1].toInt()).shade], ))),
                                                      ]),
                                                ),
                                              )
                                            ]),
