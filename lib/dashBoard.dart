...
class _DashBoardState extends State<DashBoard> {
  ...
  Widget build(BuildContext context) {
    var pictureWidth=MediaQuery.of(context).size.width/1.6;
    print(pictures[5]);
    ...
    var ninetyDaysData=selectData([DateTime.now().subtract(Duration(days:89)),DateTime.now().add(new Duration(days: 1))]);
                          ...
                          child: Column(
                            children: <Widget>[
                              Padding(
                                ...
                                child: Text("Entrez votre humeur entre -100 et 100 :",textScaleFactor: 1.2, textAlign: TextAlign.center,style: black,),
                              ),
                              ClipRRect(
